...
export class WRIHoldingsComponent implements OnInit {
  ...
  separateDataIntoCategories(){
    ...
    this.categories = [];
    if (this.options.category1 === null) {
    ...
    let primaryColumn = this.identifyPrimaryColumn(this.options.category1);
    ...
    this.categories.forEach(category1 => {
      ...
      if (this.options.category2 !== null) {
        //need to further categorize.
        primaryColumn = this.identifyPrimaryColumn(this.options.category2);
        ...
        category1.subCategories.forEach(category2 => {
          ...
          if (this.options.category3 !== null) {
            //need to further categorize.
            primaryColumn = this.identifyPrimaryColumn(this.options.category3);
  ...
  calculateSummaryData(category: Category) {
    ...
    this.options.dataColumns.forEach(column => {
