...
import { MultiSelectionComponent, MultiSelectSelection, MultiSelectSet, SingleOptionSet } from './multi-selection.component';
...
export const HoldingsR1 = Template.bind({});
HoldingsR1.args = {
  name: 'Columns',
  selectionSets: holdingsValueSetsR1
};