...
export class GraphTableReportBuilderComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.rowMultiSelection = [
      {name: 'Beginning Value', selected: true, disabled: true, draggable: false, element:null},
      {name: 'Net Contribution', selected: true, disabled: false, draggable: true, element:null},
      {name: 'Change in Value', selected: true, disabled: false, draggable: true, element:null},
    ...
    this.rowMultiSelection2 = [
      {name: 'Beginning Value1', selected: true, disabled: true, draggable: false, element:null},
      {name: 'Net Contribution1', selected: true, disabled: false, draggable: true, element:null},
      {name: 'Change in Value1', selected: true, disabled: false, draggable: true, element:null},
      ...
      {name: 'Show Benchmarks associated to the portfolio1', selected: true, disabled: false, draggable: false, element:null},
    ];
